...
<td style="text-align: center;"><a href="../images/pembayaran/<?= $row['gambar'] ?>" target="_blank"><img src="../images/pembayaran/<?php echo $row['gambar']; ?>" style="width: 120px;"></a></td>
...
<a href="index.php?module=hapuskonfirmasi&id_konfirmasi=<?php echo $row['id_konfirmasi']?><?php echo $row['gambar']; ?>"class="btn btn-danger">Hapus</a>
</td>
</tr>
