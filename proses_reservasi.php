...
<?php
    ...
    $sqlstatus = "UPDATE kamar SET status='Tidak Tersedia' WHERE No_Kamar='$kamar'";

    if(mysqli_query($conn,$sql)){
        // Execute the update query if the insert was successful
        if (mysqli_query($conn, $sqlstatus)) {
            ...
            echo "<script>
                alert('Reservasi gagal! Kesalahan Database saat mengupdate status kamar!');
