      ...
      <div class="media-with-text p-md-5">
        <div class="img-border-sm mb-4">
          <a href="#" class="popup-vimeo image-play">
            <img src="images/kamar/<?= $value['gambar']; ?>" alt="" class="img-fluid">
          </a>
        </div>
...
<div class="site-section">
  <div class="container">
    <div class="row">
      <div class="col-md-6 mx-auto text-center mb-5 section-heading">
        <h2 class="mb-5">Fasilitas Tambahan Villa</h2>
      </div>
    </div>
      </div>
  ...
  <div class="container">
    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-6 col-lg-3">
        <a href="images/kamar/<?= $value['gambar']; ?>" class="image-popup img-opacity"><img src="images/kamar/<?= $value['gambar']; ?>" alt="Image" class="img-fluid"></a>
      </div>
      <?php
      }
      ?>
